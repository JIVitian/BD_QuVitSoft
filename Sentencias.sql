...
DELIMITER //
CREATE PROCEDURE `insertarArticulo`(IN nombre VARCHAR(45), IN  marca VARCHAR(45), IN iva FLOAT,
									IN stock FLOAT, IN stockmin FLOAT, IN descrip VARCHAR(200))
BEGIN
